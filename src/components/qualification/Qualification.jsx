...
{/* ===============    Experience    ======================= */}
            ...
            className={
             ...
             <div className="qualification__data">
               ...
               <div style={{border:"var(--border)"}}>
               <h3 className="qualification__title">Mern Stack(3 Months Fellowship)</h3>
             ...
             <div className="qualification__data">
               ...
               <div style={{border:"var(--border)"}}>
               <h3 className="qualification__title">Freight Forwarding & Logistics</h3>
               <span className="qualification__subtitle">Allied Logistics Services</span>
               <div className="qualification__calendar">
